...
ax.add_image(request,zoom_level,interpolation='none') #Adding the map
...
plt.title(f'Observed lightning {lightning1.times[0].date()}, {start_time[11:-1]}-{end_time[11:-1]} UTC')
plt.show()
